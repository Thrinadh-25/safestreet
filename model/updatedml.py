...
road_model.load_state_dict(torch.load(r"C:\safestreet(updating)\model\road_classifier.pth", map_location=device))
road_model.eval()
...
damage_model.load_state_dict(torch.load(r"C:\safestreet(updating)\model\best_damage_vit_model (1).pth", map_location=device))
damage_model.eval()
